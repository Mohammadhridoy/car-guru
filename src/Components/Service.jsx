...
const Service = () => {
    return (
      <div className="  lg:px-8 ">
        <div className=" px-4 md:px-12 py-4  md:py-12 bg-[#f6f6f6] md:rounded-3xl ">
            <h1 className="text-black font-bold md:text-4xl">How Does It Work</h1>
            <p  className="text-gray-400 mt-2 md:text-xl">Here are some of the featured cars in different categories</p>
            <div className="grid md:grid-cols-4 gap-8 md:py-9">
            <div>
                <div className="w-60 text-center md:py-7">
                    ...
                    <h1 className="text-black font-bold md:text-xl py-2">Choose Any where</h1>
            ...
            <div>
                <div className="w-60 text-center py-7">
                    ...
                    <h1 className="text-black font-bold md:text-xl py-2">Contact With Us</h1>
                    <p className="text-gray-400  ">Car servicing is the regular maintenance and inspection of a vehicle to ensure.</p>
                </div>
            </div>
            ...
            <div>
                <div className="w-60 text-center py-7">
                    ...
                    <h1 className="text-black font-bold md:text-xl py-2">Pay For The Car</h1>
                    <p className="text-gray-400  ">Car servicing is the regular maintenance and inspection of a vehicle to ensure.</p>
                </div>
            </div>
            ...
            <div>
                <div className="w-60 text-center py-7">
                    ...
                    <h1 className="text-black font-bold md:text-xl py-2">Recieve The Car</h1>
                    <p className="text-gray-400  ">Car servicing is the regular maintenance and inspection of a vehicle to ensure.</p>
                </div>
            </div>
            </div>
