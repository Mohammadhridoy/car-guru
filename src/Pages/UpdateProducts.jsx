...
const UpdateProducts = () => {
    const loadUpdateinfo = useLoaderData()
        ...
        <div className="px-4 md:px-12 py-4 md:py-2">
            ...
            <div className=" lg:min-h-screen  ">
                ...
                <div className="max-w-xl lg:max-w-3xl lg:w-4/5 ml-[90px] lg:mx-auto">
                    ...
                    <form onSubmit={handleUpdate} className="mt-8 space-y-3 md:space-y-6 lg:w-4/5 lg:pl-[80px] ">
                     ...
                     <div>
                            ...
                            <select
                                defaultValue={loadUpdateinfo.brand}
                                name="brand"
                                id="Brand"
                                className="mt-1.5 w-full rounded-lg  text-gray-700 sm:text-sm p-2  border border-red-400 shadow-md"
                            >
                     ...
                     <div>
                            ...
                            <select
                                defaultValue={loadUpdateinfo.type}
                                name="type"
                                id="Type"
                                className="mt-1.5 w-full rounded-lg  text-gray-700 sm:text-sm p-2  border border-red-400 shadow-md"
                            >
                    ...
                    <div className="col-span-6 sm:col-span-3">
                        ...
                        <input
                        defaultValue={loadUpdateinfo.name}
                        type="text"
                        id="Name"
                        name="name"
                    ...
                    <div className="col-span-6 sm:col-span-3 " >
                        ...
                        <input
                        defaultValue={loadUpdateinfo.image}
                        type="text"
                        id="image"
                        name="image"
                    ...
                    <div className="col-span-6">
                        ...
                        <input
                        defaultValue={loadUpdateinfo.price}
                        type="text"
                        id="Price"
                        name="price"
                        className="mt-1 lg:w-full rounded-md  bg-white text-sm text-gray-700  p-2  border border-red-400 shadow-md"
                    ...
                    <div className="col-span-6 sm:col-span-3">
                        ...
                        <input
                        defaultValue={loadUpdateinfo.description}
                        type="text"
                        id="description"
                        name="description"
                        className="mt-1 lg:w-full rounded-md  bg-white text-sm text-gray-700  p-2  border border-red-400 shadow-md"
                    ...
                    <div className="col-span-6 sm:col-span-3">
                        ...
                        <input
                        defaultValue={loadUpdateinfo.rating}
                        type="text"
                        id="Rating"
                        name="rating"
                        className="mt-1 lg:w-full rounded-md  bg-white text-sm text-gray-700  p-2  border border-red-400 shadow-md"
                    ...
                    <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                        ...
                        <button
                        className="inline-block shrink-0 rounded-md lg:w-full  bg-red-400 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-[#46D993] hover:border-none focus:outline-none focus:ring active:text-blue-500"
                        >
                         Update Product
                        </button>
